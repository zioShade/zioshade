...
const UniFunc = struct {
    ...
    derivatives: []const UniSample, aab945fa (wgsl: refuse derivative builtins in non-uniform control flow (#685))
    is_entry_point: bool,
...
const UniformityAnalysis = struct {
    ...
    fn parse(a: *UniformityAnalysis) !void {
        ...
        while (i < m.instructions.len) : (i += 1) {
            ...
            var derivs = std.ArrayListUnmanaged(UniSample).empty; aab945fa (wgsl: refuse derivative builtins in non-uniform control flow (#685))
            ...
            try funcs.append(a.arena, .{
                ...
                .derivatives = derivs.items, aab945fa (wgsl: refuse derivative builtins in non-uniform control flow (#685))
