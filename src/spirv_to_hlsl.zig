...
pub fn spirvToHLSL(
    ...
    // Mangle function-local variables whose name collides with a GLOBAL
    // variable's (the only collision that silently shadows -- #sid). Scope-aware:
    // leaves type/variable + same-scope collisions alone.
