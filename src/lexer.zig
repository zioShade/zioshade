...
fn makeKeywordMap() KeywordMap {
    return comptime KeywordMap.initComptime(.{
        ...
        .{ "isamplerBuffer", .kw_isampler_buffer },
        .{ "usamplerBuffer", .kw_usampler_buffer },
        .{ "sampler2DMS", .kw_sampler2d_ms },
        .{ "samplerCubeArray", .kw_sampler_cube_array },
        .{ "samplerCubeArrayShadow", .kw_sampler_cube_array_shadow },
        ...
        .{ "iimageBuffer", .kw_iimage_buffer },
        .{ "uimageBuffer", .kw_uimage_buffer },
        .{ "image2DMS", .kw_image2d_ms },
        .{ "image2DMSArray", .kw_image2d_ms_array },
        .{ "image1D", .kw_image1d },
        .{ "iimage1D", .kw_iimage1d },
        .{ "uimage1D", .kw_uimage1d },
        .{ "iimage3D", .kw_iimage3d },
        .{ "uimage3D", .kw_uimage3d },
        .{ "iimageCube", .kw_iimage_cube },
        .{ "uimageCube", .kw_uimage_cube },
        .{ "iimage2DArray", .kw_iimage2d_array },
        .{ "uimage2DArray", .kw_uimage2d_array },
        .{ "imageCubeArray", .kw_image_cube_array },
        .{ "iimageCubeArray", .kw_iimage_cube_array },
        .{ "uimageCubeArray", .kw_uimage_cube_array },
        .{ "texture2D", .kw_texture2d },
        .{ "texture3D", .kw_texture3d },
        .{ "textureCube", .kw_texture_cube },
        .{ "texture2DArray", .kw_texture2d_array },
        .{ "texture2DMS", .kw_texture2d_ms },
        .{ "accelerationStructureEXT", .kw_acceleration_structure_ext },
        .{ "rayQueryEXT", .kw_ray_query_ext },
        .{ "tensorARM", .kw_tensor_arm },
        .{ "subpassInput", .kw_subpass_input },
        .{ "subpassInputMS", .kw_subpass_input_ms },
