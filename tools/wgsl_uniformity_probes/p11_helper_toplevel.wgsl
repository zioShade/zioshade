// Uniformity probe p11_helper_toplevel: WGSL uniformity prepass tint-evidence
...
// RULE EVIDENCED:
//   a helper function inherits the flow of its CALL SITES: called only from
//   uniform flow, its in-body sample stays implicit
