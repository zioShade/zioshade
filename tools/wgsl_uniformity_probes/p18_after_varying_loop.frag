// Staging driver for uniformity probe p18_after_varying_loop. Exists ONLY so
...
// replaces the output with p18_after_varying_loop.wgsl (the probe text) before the
