// Staging driver for uniformity probe p05_uniform_early_return. Exists ONLY so
...
// replaces the output with p05_uniform_early_return.wgsl (the probe text) before the
