// Staging driver for uniformity probe p09_varying_bound_loop. Exists ONLY so
...
// replaces the output with p09_varying_bound_loop.wgsl (the probe text) before the
