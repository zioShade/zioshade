// Staging driver for uniformity probe p12_helper_in_nonuniform_if. Exists ONLY so
...
// replaces the output with p12_helper_in_nonuniform_if.wgsl (the probe text) before the
