// Staging driver for uniformity probe p22_indexed_uniform_read. Exists ONLY so
...
// replaces the output with p22_indexed_uniform_read.wgsl (the probe text) before the
