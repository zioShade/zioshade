// Staging driver for uniformity probe p03_early_return_one_arm. Exists ONLY so
...
// replaces the output with p03_early_return_one_arm.wgsl (the probe text) before the
