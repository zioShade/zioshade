// Uniformity probe p01_control: WGSL uniformity prepass tint-evidence
...
// RULE EVIDENCED:
//   control: a plain implicit-Lod sample in uniform flow; nothing has diverged yet
// CITED BY: the base case every other probe is measured against
