// Staging driver for uniformity probe p08_uniform_bound_loop. Exists ONLY so
...
// replaces the output with p08_uniform_bound_loop.wgsl (the probe text) before the
