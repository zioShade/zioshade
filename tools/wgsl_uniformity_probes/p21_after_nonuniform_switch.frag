// Staging driver for uniformity probe p21_after_nonuniform_switch. Exists ONLY so
...
// replaces the output with p21_after_nonuniform_switch.wgsl (the probe text) before the
